---
name: "Invite acceptance missing expiry check"
about: "Autter Sandbox challenge"
title: "Invite acceptance missing expiry check"
labels: ["autter-sandbox", "business logic"]
---

# Challenge: Invite acceptance missing expiry check
...
Expired invites can still be accepted.
...
Fix the issue where expired invites can still be accepted.
...
- broken business logic and missing edge-case tests
