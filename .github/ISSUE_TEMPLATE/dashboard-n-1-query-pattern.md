---
name: "Dashboard N+1 query pattern"
about: "Autter Sandbox challenge"
title: "Dashboard N+1 query pattern"
labels: ["autter-sandbox", "performance"]
---

# Challenge: Dashboard N+1 query pattern
...
The dashboard loads project usage with inefficient repeated calls.
...
Fix the issue where the dashboard loads project usage with inefficient repeated calls.
