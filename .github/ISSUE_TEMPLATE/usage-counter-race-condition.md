---
name: "Usage counter race condition"
about: "Autter Sandbox challenge"
title: "Usage counter race condition"
labels: ["autter-sandbox", "reliability"]
---

# Challenge: Usage counter race condition
...
Concurrent usage events can overwrite each other and undercount usage.
...
Fix the issue where concurrent usage events can overwrite each other and undercount usage.
...
- data consistency and concurrency risk
