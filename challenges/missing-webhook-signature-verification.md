# Challenge: Missing webhook signature verification
...
The billing webhook endpoint accepts unsigned payloads.
...
Fix the issue where the billing webhook endpoint accepts unsigned payloads.
...
- security risk at an external trust boundary
